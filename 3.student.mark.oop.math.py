...
class University:
                ...
                if len(self.course_student[choose-1]) == 0:
                    ...
                    for i in range(len(self.course_student[choose-1])):
                        if st_input == self.course_student[choose-1][i].getId():
                            ...
                            self.course_student[choose -1][i].mark[f"Mark_{course_list[choose-1].getName()}"] = math.floor(mark*10)/10
                    if exist == False:
    ...
    def show_gpa(self,student_list,course_list):
        if len(student_list) == 0 or len(course_list) == 0:
            print("Please input information for students and courses")
        else:
            self.show_students(student_list)
    ...
    def sorting_gpa(self,student_list,course_list):
        if len(student_list) == 0 or len(course_list) == 0:
            print("Please input information for students and courses")
        else:
...
def main():
    ...
    while True:
        ...
        if choose == '0':
            ...
            u.show_gpa(u.student_list,u.course_list)
        
        elif choose == '10':
            u.sorting_gpa(u.student_list,u.course_list)
